...
function AppProvider({ children }) {
    ...
    const [filters, setFiltersState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(DEFAULT_FILTERS);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AppProvider.useEffect": ()=>{
            ...
            const { data: sub } = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.onAuthStateChange({
                "AppProvider.useEffect": (_evt, sess)=>{
        ...
        "AppProvider.useEffect": ()=>{
            ({
                "AppProvider.useEffect": async ()=>{
                    if (user) {
                        // загружаем с сервера
                        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("favorites").select("design_id, image, room_type, styles").order("created_at", {
                            ascending: false
                        });
                        if (!error && data) {
                            setFavorites(data.map({
                                "AppProvider.useEffect": (r)=>({
                                        id: r.design_id,
                                        image: r.image,
                            ...
                            try {
                                ...
                                if (localRaw) {
                                    ...
                                    const toUpload = local.filter({
                                        "AppProvider.useEffect.toUpload": (L)=>!data.find({
                                                "AppProvider.useEffect.toUpload": (D)=>D.design_id === L.id
                                            }["AppProvider.useEffect.toUpload"])
                                    }["AppProvider.useEffect.toUpload"]);
                                    if (toUpload.length) {
                                        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("favorites").insert(toUpload.map({
                                            "AppProvider.useEffect": (d)=>({
                                                    design_id: d.id,
                                                    image: d.image,
    ...
    const addFavorite = async (d)=>{
        ...
        if (user) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("favorites").insert({
                design_id: d.id,
                image: d.image,
                room_type: d.roomType,
                styles: d.style
    ...
    const removeFavorite = async (id)=>{
        ...
        if (user) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("favorites").delete().eq("design_id", id);
        }
    };
    const clearFavorites = async ()=>{
        ...
        if (user) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("favorites").delete().neq("design_id", "___never___");
        }
    };
...
_s(AppProvider, "AiI5WQpKTWPumU3SxhX3xeNmtrs=");
_c = AppProvider;
const useApp = ()=>{
    _s1();
...
function ProfilePage() {
    _s();
    const { favorites, filters, resetFilters, removeFavorite, clearFavorites } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$context$2f$AppContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useApp"])();
...
_s(ProfilePage, "aRVODPjRYV/pQjzZyibsBvnDKTA=", false, function() {
    return [
...
//# sourceMappingURL=_a37ecb50._.js.map